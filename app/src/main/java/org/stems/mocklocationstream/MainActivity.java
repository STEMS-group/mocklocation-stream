package org.stems.mocklocationstream;
...
import org.stems.mocklocationstream.utils.JSONHelper;
...
public class MainActivity extends Activity implements
	...
	class RetrievePositionTask extends AsyncTask<String, String, String> {
    	...
    	protected void onProgressUpdate(String... msg) {
            Log.d(LOG_TAG, "I received this: " + Arrays.toString(msg));
